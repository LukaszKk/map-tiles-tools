...
class ExecutorService:
    ...
    def basicMerge(self, input_dir):
        ...
        if len(self.file_names) == 0:
            ...
            Io.copyAllFiles(src=input_dir, dest=self.path_provider,
    ...
    def profileMerge(self, input_dir):
        ...
        if len(self.file_names) == 0:
            ...
            Io.copyAllFiles(src=input_dir, dest=self.path_provider.output_tmp_path,
        ...
        if len(self.file_names) == 0:
            ...
            Io.copyAllFiles(src=input_dir, dest=self.path_provider.output_tmp2_path,
        ...
        # Io.makeDirectory(self.path_provider.output_data_path + '1\\')
        # Io.makeDirectory(self.path_provider.output_data_path + '2\\')
        # Io.makeDirectory(self.path_provider.output_data_path + '3\\')
        # Io.makeDirectory(self.path_provider.output_data_path + '4\\')
